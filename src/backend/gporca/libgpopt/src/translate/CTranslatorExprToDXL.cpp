	...
	)
{
	...
	pds->AddRef();
	pdrgpdsBaseTables->Append(pds);
	return PdxlnIndexOnlyScan(pexprIndexScan, colref_array, dxl_properties, pexprIndexScan->Prpp());
}
	...
	)
{
	...
	CPhysicalIndexOnlyScan *popIs = CPhysicalIndexOnlyScan::PopConvert(pexprIndexScan->Pop());
